...
namespace ES3Types
{
	...
	[ES3PropertiesAttribute("chestRenderer", "chestShadowRenderer", "chestHoveredVisual", "openedSprite", "closedSprite", "openedSpriteShadow", "closedSpriteShadow", "solidChestCollider", "placingBuildingBackgroundSprite", "buildingHoveredVisual", "validPlacementColor", "unValidPlacementColor", "solidBuildingCollider", "interactionBuildingCollider", "building", "buildingScoreText", "groundTileMap")]
		...
		protected override void ReadComponent<T>(ES3Reader reader, object obj)
		{
			...
			foreach(string propertyName in reader.Properties)
			{
				switch(propertyName)
				{
					...
					break;
					case "groundTileMap":
					instance = (ChestVisual)reader.SetPrivateField("groundTileMap", reader.Read<UnityEngine.Transform>(), instance);
					break;
					default:
						reader.Skip();
						break;
