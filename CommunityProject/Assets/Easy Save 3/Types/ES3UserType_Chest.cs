...
namespace ES3Types
{
	...
	[ES3PropertiesAttribute("chestInventory", "chestInventoryUI", "isDungeonChest", "buildingHaulersUI_World", "itemCategoryToStore", "chestVisual", "buildingSO", "buildingVisual", "buildingPlaced", "assignedHumanoid", "assignedInputHauliers", "assignedOutputHauliers")]
	public class ES3UserType_Chest : ES3ComponentType
	{
		...
		protected override void WriteComponent(object obj, ES3Writer writer)
		{
			...
			writer.WritePrivateFieldByRef("chestVisual", instance);
		...
		protected override void ReadComponent<T>(ES3Reader reader, object obj)
		{
			...
			foreach(string propertyName in reader.Properties)
			{
				switch(propertyName)
				{
					...
					break;
					case "chestVisual":
					instance = (Chest)reader.SetPrivateField("chestVisual", reader.Read<ChestVisual>(), instance);
					break;
					case "buildingSO":
